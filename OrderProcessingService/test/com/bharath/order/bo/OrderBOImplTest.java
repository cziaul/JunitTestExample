...
//		bo.setDao(dao);
	...
	public void testMock(){
		System.out.println("testMock called");
		OrderDAO mockDao = mock(OrderDAO.class);
		mockDao.bizLogicMethod();
	}	
	
	@Test
	public void testSpy(){
		System.out.println("testSpy called");
		OrderDAO spyDao = spy(new OrderDAOImpl());
//		Mockito.doReturn(100).when(spyDao).dbCallMethod();
		spyDao.bizLogicMethod();
	}
